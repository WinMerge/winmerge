...
<h2>WinMerge 2.4.8 - latest stable version</h2>
<p><a href="2.4/index.php">WinMerge 2.4.8</a> is the latest stable version, and it is recommended for most users.</p>
<p><a href="http://prdownloads.sourceforge.net/winmerge/WinMerge-2.4.8-Setup.exe">Download WinMerge 2.4.8 Installer</a></p>
...
<h2>Installation</h2>
<p>Just download the <a href="http://prdownloads.sourceforge.net/winmerge/WinMerge-2.4.8-Setup.exe">installer</a> and double-click it.</p>
<p>Or you may simply unzip the <a href="http://prdownloads.sourceforge.net/winmerge/WinMerge-2.4.8-exe.zip">binary zip package</a> into the desired location, and run
