...
MSBuild WinMerge32BitPluginProxy.vs2017.sln /t:Rebuild /p:Configuration="Release" /p:Platform="Win32" || goto :eof
popd
...
pushd src_VCPP
MSBuild VCPPPlugins.vs2017.sln /t:Rebuild /p:Configuration="Release" /p:Platform="%PLATFORM_VS%" || goto :eof
popd
