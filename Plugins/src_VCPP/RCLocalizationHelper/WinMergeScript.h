...
// change 3 : insert the text ", 1, 0, CComTypeInfoHolderFileOnly" 
	// public IDispatchImpl<IWinMergeScript, &IID_IWinMergeScript, &LIBID_RCLocalizationHelperLib>
	public IDispatchImpl<IWinMergeScript, &IID_IWinMergeScript, &LIBID_RCLocalizationHelperLib, 1, 0, CComTypeInfoHolderFileOnly>
{
public:
	CWinMergeScript()
	{
