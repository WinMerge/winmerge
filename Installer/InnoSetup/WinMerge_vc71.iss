...
#define AppVersion GetFileVersion(SourcePath + "\..\..\Build\vc71\MergeUnicodeRelease\WinMergeU.exe")
#define FriendlyAppVersion Copy(GetFileVersion(SourcePath + "\..\..\Build\vc71\MergeUnicodeRelease\WinMergeU.exe"), 1, 5)
...
OutputBaseFilename=WinMerge-{#AppVersion}-Setup-vc71
...
Source: ..\..\Build\vc71\MergeUnicodeRelease\WinMergeU.exe; DestDir: {app}; Flags: promptifolder; MinVersion: 0, 4; Components: Core
Source: ..\..\Build\vc71\MergeRelease\WinMerge.exe; DestDir: {app}; Flags: promptifolder; OnlyBelowVersion: 0, 4; Components: Core
...
; Shell extension
Source: ..\..\Build\vc71\ShellExtensionRelease mindependency\ShellExtension.dll; DestDir: {app}; Flags: regserver uninsrestartdelete restartreplace promptifolder; MinVersion: 4, 0; Check: not IsWin64
Source: ..\..\Build\vc71\ShellExtensionUnicode Release mindependency\ShellExtensionU.dll; DestDir: {app}; Flags: regserver uninsrestartdelete restartreplace promptifolder; MinVersion: 0, 4; Check: not IsWin64
