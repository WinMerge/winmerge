...
SelectLanguageLabel=インストル中に使用する言語を選択します:
...
;SelectDirLabel2=[name] をインストールするフォルダを指定して、「次へ」をクリックしてください。
SelectDirLabel3=[name] を以下のフォルダにインストールします。
SelectDirBrowseLabel=続行するには、「次へ」をクリックしてください。別フォルダにインストールする場合は、「参照」をクリックしてください。
...
SelectStartMenuFolderLabel3=セットアップは次のスタートメニューフォルダにプログラムのショートカットを作成します。
;SelectStartMenuFolderLabel2=プログラムのアイコンを作成するプログラムグループを指定して、「次へ」をクリックしてください。
SelectStartMenuFolderBrowseLabel=続行するには、「次へ」をクリックしてください。別フォルダを選択したい場合は、「参照」をクリックしてください。
