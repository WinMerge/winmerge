...
; Binary file editor
Source: ..\..\Build\heksedit\heksedit.dll; DestDir: {app}; Flags: promptifolder skipifsourcedoesntexist ; OnlyBelowVersion: 0, 4; Components: Core
Source: ..\..\Build\heksedit\hekseditU.dll; DestDir: {app}; Flags: promptifolder skipifsourcedoesntexist ; MinVersion: 0, 4; Components: Core
