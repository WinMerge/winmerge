...
const tLangDef lang_map[] =
{
	...
	{IDS_ARABIC_EGYPT, NONATIVE, MAKELANGID(LANG_ARABIC, SUBLANG_ARABIC_EGYPT), _T("")},  
	...
	{IDS_BELARUSIAN, NONATIVE, MAKELANGID(LANG_BELARUSIAN, SUBLANG_DEFAULT), _T("")},
	{IDS_BULGARIAN, NONATIVE, MAKELANGID(LANG_BULGARIAN, SUBLANG_DEFAULT), _T("")},
	{IDS_CATALAN, L"Catal\xE0", MAKELANGID(LANG_CATALAN, SUBLANG_DEFAULT), _T("")},
	// zhongwen
	{IDS_CHINESE_TRADITIONAL, L"\x4E2d\x6587 (Traditional)", MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_TRADITIONAL), _T("cht")},
	// zhongwen (jian3dan1)
	...
	{IDS_CZECH, NONATIVE, MAKELANGID(LANG_CZECH, SUBLANG_DEFAULT), _T("czech")},
	...
	{IDS_FARSI, NONATIVE, MAKELANGID(LANG_FARSI, SUBLANG_DEFAULT), _T("")},
	{IDS_FINNISH, NONATIVE, MAKELANGID(LANG_FINNISH, SUBLANG_DEFAULT), _T("fin")},
	{IDS_FRENCH, L"Fran\347ois", MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH), _T("fra")},  
	{IDS_FRENCH_BELGIAN, NONATIVE, MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH_BELGIAN), _T("frb")},   
	{IDS_FRENCH_CANADIAN, NONATIVE, MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH_CANADIAN), _T("frc")},   
	{IDS_FRENCH_SWISS, NONATIVE, MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH_SWISS), _T("frs")},   
	{IDS_FRENCH_LUXEMBOURG, NONATIVE, MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH_LUXEMBOURG), _T("french")},   
	{IDS_FRENCH_MONACO, NONATIVE, MAKELANGID(LANG_FRENCH, SUBLANG_FRENCH_MONACO), _T("")},
	...
	{IDS_GREEK, NONATIVE, MAKELANGID(LANG_GREEK, SUBLANG_DEFAULT), _T("greek")},
	{IDS_HEBREW, NONATIVE, MAKELANGID(LANG_HEBREW, SUBLANG_DEFAULT), _T("")},
	...
	{IDS_ICELANDIC, NONATIVE, MAKELANGID(LANG_ICELANDIC, SUBLANG_DEFAULT), _T("isl")},
	...
	{IDS_KAZAK, NONATIVE, MAKELANGID(LANG_KAZAK, SUBLANG_DEFAULT), _T("")},
	// hangukhua in Hanja (should get this in Hangul ?)
	{IDS_KOREAN, L"\x97D3\x56FD\x8A9E", MAKELANGID(LANG_KOREAN, SUBLANG_KOREAN), _T("kor")},
	{IDS_LATVIAN, NONATIVE, MAKELANGID(LANG_LATVIAN, SUBLANG_DEFAULT), _T("")},
	{IDS_LITHUANIAN, NONATIVE, MAKELANGID(LANG_LITHUANIAN, SUBLANG_DEFAULT), _T("")},
	...
	{IDS_PORTUGUESE, NONATIVE, MAKELANGID(LANG_PORTUGUESE, SUBLANG_PORTUGUESE), _T("ptg")},
	{IDS_PORTUGUESE_BRAZILIAN, NONATIVE, MAKELANGID(LANG_PORTUGUESE, SUBLANG_PORTUGUESE_BRAZILIAN), _T("ptb")},
	{IDS_ROMANIAN, NONATIVE, MAKELANGID(LANG_ROMANIAN, SUBLANG_DEFAULT), _T("")},
	{IDS_RUSSIAN, NONATIVE, MAKELANGID(LANG_RUSSIAN, SUBLANG_DEFAULT), _T("rus")},
	...
	{IDS_SERBIAN_CYRILLIC, NONATIVE, MAKELANGID(LANG_SERBIAN, SUBLANG_SERBIAN_CYRILLIC), _T("")},
	{IDS_SINDHI, NONATIVE, MAKELANGID(LANG_SINDHI, SUBLANG_DEFAULT), _T("")},
	{IDS_SLOVAK, NONATIVE, MAKELANGID(LANG_SLOVAK, SUBLANG_DEFAULT), _T("sky")},
	{IDS_SLOVENIAN, NONATIVE, MAKELANGID(LANG_SLOVENIAN, SUBLANG_DEFAULT), _T("")},
	{IDS_SPANISH, NONATIVE, MAKELANGID(LANG_SPANISH, SUBLANG_SPANISH), _T("esm")}, 
	{IDS_SPANISH_MEXICAN, NONATIVE, MAKELANGID(LANG_SPANISH, SUBLANG_SPANISH_MEXICAN), _T("esp")}, 
	{IDS_SPANISH_MODERN, L"Español (Moderno)", MAKELANGID(LANG_SPANISH, SUBLANG_SPANISH_MODERN), _T("esn")}, 
	...
	{IDS_THAI, NONATIVE, MAKELANGID(LANG_THAI, SUBLANG_DEFAULT), _T("")},
	{IDS_TURKISH, NONATIVE, MAKELANGID(LANG_TURKISH, SUBLANG_DEFAULT), _T("trk")},
	{IDS_UKRANIAN, NONATIVE, MAKELANGID(LANG_UKRAINIAN, SUBLANG_DEFAULT), _T("")},
	{IDS_URDU_PAKISTAN, NONATIVE, MAKELANGID(LANG_URDU, SUBLANG_URDU_PAKISTAN), _T("")},
	{IDS_URDU_INDIA, NONATIVE, MAKELANGID(LANG_URDU, SUBLANG_URDU_INDIA), _T("")},
	{IDS_UZBEK_LATIN, NONATIVE, MAKELANGID(LANG_UZBEK, SUBLANG_UZBEK_LATIN), _T("")},
	{IDS_UZBEK_CYRILLIC, NONATIVE, MAKELANGID(LANG_UZBEK, SUBLANG_UZBEK_CYRILLIC), _T("")},
	{IDS_VIETNAMESE, NONATIVE, MAKELANGID(LANG_VIETNAMESE, SUBLANG_DEFAULT), _T("")},
	{0, NONATIVE, 0, NULL},
};
