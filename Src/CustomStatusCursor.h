/**
 *  @file CustomStatusCursor.h
 *
 *  @brief Declaration CustomStatusCursor classes.
 */ 
// ID line follows -- this is updated by SVN
// $Id$

#ifndef CustomStatusCursor_included_h
#define CustomStatusCursor_included_h
...
#endif // CustomStatusCursor_included_h
