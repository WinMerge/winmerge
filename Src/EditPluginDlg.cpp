...
CEditPluginDlg::CEditPluginDlg(const String& pluginPipeline, const String& filename,
...
void CEditPluginDlg::prepareListbox() 
{
	int sel = -1;
...
void CEditPluginDlg::OnUnpackerAllowAll() 
{
	UpdateData ();
...
void CEditPluginDlg::OnClickedAddPipe()
{
	UpdateData();
...
void CEditPluginDlg::OnChangePipeline()
{
	UpdateData(TRUE);
}

void CEditPluginDlg::OnSelchangeUnpackerName() 
{
...
void CEditPluginDlg::OnClickedSettings() 
{
