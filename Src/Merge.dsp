...
TargetPath=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeDebug\WinMerge.exe
SOURCE="$(InputPath)"
...
# ADD LINK32 version.lib shlwapi.lib imm32.lib HtmlHelp.lib libexpat.lib pcre.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /profile /map /debug /machine:I386 /out:"..\Build\MergeUnicodeDebug/WinMergeU.exe" /pdbtype:sept /libpath:"..\Build\expat" /libpath:"..\Build\pcre" /libpath:"..\Build\scew"
# Begin Custom Build
IntDir=.\..\BuildTmp\MergeUnicodeDebug
TargetDir=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeUnicodeDebug
InputPath=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeUnicodeDebug\WinMergeU.exe
SOURCE="$(InputPath)"

"$(TargetDir)\WinMergeU.map" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(IntDir)\WinMergeU.map $(TargetDir)

# End Custom Build
# Begin Special Build Tool
IntDir=.\..\BuildTmp\MergeUnicodeDebug
TargetPath=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeUnicodeDebug\WinMergeU.exe
SOURCE="$(InputPath)"
PreLink_Cmds=PreLink.bat $(IntDir) $(TargetPath)
PostBuild_Cmds=PostBuild.bat $(IntDir) $(TargetPath)
# End Special Build Tool
...
TargetPath=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeRelease\WinMerge.exe
SOURCE="$(InputPath)"
PreLink_Cmds=PreLink.bat $(IntDir) $(TargetPath)
PostBuild_Cmds=PostBuild.bat $(IntDir) $(TargetPath)
# End Special Build Tool
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 version.lib shlwapi.lib imm32.lib HtmlHelp.lib libexpat.lib pcre.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /profile /map /debug /machine:I386 /nodefaultlib:"msvcrtd.lib" /out:"..\Build\MergeUnicodeRelease\WinMergeU.exe" /libpath:"..\Build\expat" /libpath:"..\Build\pcre" /libpath:"..\Build\scew" /verbose:lib
# Begin Custom Build
IntDir=.\..\BuildTmp\MergeUnicodeRelease
TargetDir=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeUnicodeRelease
InputPath=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeUnicodeRelease\WinMergeU.exe
SOURCE="$(InputPath)"
...
# Begin Special Build Tool
IntDir=.\..\BuildTmp\MergeUnicodeRelease
TargetPath=\Dev\WinMergeDev\winmerge-3pane_svn\trunk\Build\MergeUnicodeRelease\WinMergeU.exe
SOURCE="$(InputPath)"
PreLink_Cmds=PreLink.bat $(IntDir) $(TargetPath)
PostBuild_Cmds=PostBuild.bat $(IntDir) $(TargetPath)
# End Special Build Tool
...
SOURCE=.\Common\UnicodeString.cpp
# SUBTRACT CPP /YX /Yc /Yu
# End Source File
# Begin Source File
...
SOURCE=.\res\lmissing.ico
# End Source File
# Begin Source File

SOURCE=.\res\lmissingfolder.ico
# End Source File
# Begin Source File
...
SOURCE=.\res\mfile.ico
# End Source File
# Begin Source File

SOURCE=.\res\mfolder.ico
# End Source File
# Begin Source File
...
SOURCE=.\res\mmissing.ico
# End Source File
# Begin Source File

SOURCE=.\res\mmissingfolder.ico
# End Source File
# Begin Source File
...
SOURCE=.\res\rmissing.ico
# End Source File
# Begin Source File

SOURCE=.\res\rmissingfolder.ico
# End Source File
# Begin Source File
