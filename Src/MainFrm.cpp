...
HMENU CMainFrame::NewMergeViewMenu()
{
	...
	m_pMenus[MENU_MERGEVIEW]->ModifyODMenu(NULL, ID_TOOLS_GENERATEREPORT, IDB_TOOLS_GENERATEREPORT);
	...
	m_pMenus[MENU_MERGEVIEW]->ModifyODMenu(NULL, ID_VIEW_ZOOMIN, IDB_VIEW_ZOOMIN);
	m_pMenus[MENU_MERGEVIEW]->ModifyODMenu(NULL, ID_VIEW_ZOOMOUT, IDB_VIEW_ZOOMOUT);
...
HMENU CMainFrame::NewDirViewMenu()
{
	...
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_LEFT_TO_RIGHT, IDB_LEFT_TO_RIGHT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_RIGHT_TO_LEFT, IDB_RIGHT_TO_LEFT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_LEFT_TO_BROWSE, IDB_LEFT_TO_BROWSE);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_RIGHT_TO_BROWSE, IDB_RIGHT_TO_BROWSE);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_MOVE_LEFT_TO_BROWSE, IDB_MOVE_LEFT_TO_BROWSE);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_MOVE_RIGHT_TO_BROWSE, IDB_MOVE_RIGHT_TO_BROWSE);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_DEL_LEFT, IDB_LEFT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_DEL_RIGHT, IDB_RIGHT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_DEL_BOTH, IDB_BOTH);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_PATHNAMES_LEFT, IDB_LEFT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_PATHNAMES_RIGHT, IDB_RIGHT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_COPY_PATHNAMES_BOTH, IDB_BOTH);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_ZIP_LEFT, IDB_LEFT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_ZIP_RIGHT, IDB_RIGHT);
	m_pMenus[MENU_DIRVIEW]->ModifyODMenu(NULL, ID_DIR_ZIP_BOTH, IDB_BOTH);
