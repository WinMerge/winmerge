...
enum MERGE_LINEFLAGS : lineflags_t
{
	...
	LF_SNP = 0x02000000UL,
	LF_DIFF_1STONLY = 0x04000000UL,
	LF_DIFF_2NDONLY = 0x08000000UL,
	LF_DIFF_3RDONLY = 0x10000000UL,
	// LF_WINMERGE_FLAGS is LF_DIFF | LF_GHOST | LF_TRIVIAL | LF_MOVED | LF_SNP | LF_DIFF_1STONLY | LF_DIFF_2NDONLY | LF_DIFF_3RDONLY
	LF_WINMERGE_FLAGS = 0x1FE00000UL,
