...
;
; Italian.isl - Last Update: 26.12.2020 by bovirus (bovirus@gmail.com)
;
; Translator name:  bovirus
; Translator email: bovirus@gmail.com
...
MissingWOW64APIs=La versione attuale di Windows non include la funzionalità richiesta dal programma di installazione per realizzare un'installazione a 64-bit.%n%nPer correggere questo problema, installa il Service Pack %1.
...
AboutSetupNote=
TranslatorNote=Traduzione italiana (v. 26.12.2020) a cura di Rinaldo M. aka Whiteshark e bovirus
...
InvalidPath=Devi inserire un percorso completo di lettera di unità; per esempio:%n%nC:\APP%n%no un percorso di rete nella forma:%n%n\\server\condivisione
...
DirDoesntExist=La cartella%n%n%1%n%nnon esiste.%n%nVuoi creare la cartella?
...
NoUninstallWarning=I seguenti componenti sono già installati:%n%n%1%n%nDeselezionando questi componenti essi non verranno rimossi.%n%nVuoi continuare comunque?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
SelectTasksLabel2=Seleziona i processi aggiuntivi da eseguire durante l'installazione di [name], quindi seleziona 'Avanti'.
...
PreparingDesc=Preparazione installazione di [name].
...
InstallingLabel=Attendi il completamento dell'installazione di%n[name].
...
UninstallOnlyOnWin64=Questa applicazione può essere disinstallata solo in sistemi Windows a 64bit.
OnlyAdminCanUninstall=Questa applicazione può essere disinstallata solo da un utente con privilegi di amministratore.
UninstallStatusLabel=Attendi il completamento della rimozione di %1.
...
UninstallDataCorrupted=Il file '%1' è danneggiato.%n%nImpossibile disinstallare
