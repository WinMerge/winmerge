...
Languages=Talen
ArabicLanguage=Arabische menu's en vensters
BasqueLanguage=Baskische menu's en vensters
...
FinnishLanguage=Finse menu’s en vensters
...
PersianLanguage=Perzische menu’s en vensters
...
SerbianLanguage=Servische menu’s en vensters
SinhalaLanguage=Sinhala menu’s en vensters
...
;Tasks
ExplorerContextMenu=&Contextmenu-integratie in Verkenner inschakelen
...
ThreeWayMergeWizardPageCaption=Vergelijking in 3 richtingen
ThreeWayMergeWizardPageDescription=Gebruikt u WinMerge als een samenvoegingstool voor TortoiseSVN/Git?
RegisterWinMergeAs3WayMergeTool=WinMerge registreren als samenvoegingstool in 3 richtingen
MergeAtRightPane=Samenvoegen in rechter venster
MergeAtCenterPane=Samenvoegen in middelste venster
MergeAtLeftPane=Samenvoegen in linker venster
AutoMergeAtStartup=Automatisch samenvoegen bij starten

;Icon Labels
ReadMe=Lees mij
UsersGuide=Gebruikershandleiding
ViewStartMenuFolder=De WinMerge startmenu-map weergeven
