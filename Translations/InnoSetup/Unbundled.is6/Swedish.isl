...
PrivilegesRequiredOverrideText1=%1 kan installeras för alla användare (kräver Administratörs-behörigheter), eller bara för Er.
PrivilegesRequiredOverrideText2=%1 kan installeras bara för Er, eller för alla användare (kräver Administratörs-behörigheter).
PrivilegesRequiredOverrideAllUsers=Installera för &alla användare
PrivilegesRequiredOverrideAllUsersRecommended=Installera för &alla användare (anrådes)
PrivilegesRequiredOverrideCurrentUser=Installera för &Mig enbart
PrivilegesRequiredOverrideCurrentUserRecommended=Installera för &Mig enbart (anrådes)
...
AbortRetryIgnoreIgnore=&Frånse felet och fortsätt
...
FileAbortRetryIgnoreSkipNotRecommended=&Hoppa över den här filen (avrådes)
FileAbortRetryIgnoreIgnoreNotRecommended=&Frånse felet och fortsätt (avrådes)
