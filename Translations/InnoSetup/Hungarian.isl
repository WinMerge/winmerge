...
;Tasks
ExplorerContextMenu=Integrálás az Intézõ &helyi-menüjébe
...
;Code Dialogs
DeletePreviousStartMenu=A Telepítő észlelte, hogy megváltoztattad a Start Menü helyét errõl: "%s" erre: "%s". Szeretnéd eltávolítani a korábbi Start Menü mappát?
