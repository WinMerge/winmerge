...
OptionalFeatures=Opcionális lehetőségek:
...
ChineseSimplifiedLanguage=Kínai (Egyszerűsített) menük és párbeszédablakok
...
TamilLanguage=Tamil menük és párbeszédablakok
...
MergeAtCenterPane=Egyesítés a középső panelen
...
;Code Dialogs
DeletePreviousStartMenu=A Telepítő észlelte, hogy megváltoztattad a Start Menü helyét erröl: "%s" erre: "%s". Szeretnéd eltávolítani a korábbi Start Menü mappát?
ExplorerNeedsRestart=Újraindítás szükséges a WinMerge-hez. Szeretnéd most újraindítani?
