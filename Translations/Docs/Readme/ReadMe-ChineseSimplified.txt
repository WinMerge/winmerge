...
WinMerge 支持
=============
如果您有 WinMerge 相关的问题或建议，请访问 https://forums.winmerge.org/。论坛当
前已迁移至 GitHub：对于 WinMerge 使用上的问题，请通过 Discussions 版块提出，对
于 WinMerge 开发相关的问题，请通过 Issues 版块提出。

问题和功能需求
==============
如果问题没有在 WinMerge 论坛得到解决，请访问 https://project.winmerge.org/ 并在
导航栏里找到问题和功能请求相关的链接，然后就可以浏览或提交新问题了。
