...
echo #!/bin/bash
echo cd $^(cygpath '%CD%'^)
echo po4a --verbose --package-name WinMerge --package-version 2.16 --copyright-holder 'Thingamahoochie Software' --msgid-bugs-address https://bugs.winmerge.org/ ./Manual.cfg
