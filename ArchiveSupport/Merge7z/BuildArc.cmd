...
if "%PLATFORM%" == "ARM64" (
  copy /y "..\..\Externals\7zip\CPP\7zip\Bundles\Format7zF\arm64\7z.dll" %DISTDIR%\%PLATFORM%\Merge7z\
) else if "%PLATFORM%" == "ARM" (
  copy /y "..\..\Externals\7zip\CPP\7zip\Bundles\Format7zF\arm\7z.dll" %DISTDIR%\%PLATFORM%\Merge7z\
) else (
