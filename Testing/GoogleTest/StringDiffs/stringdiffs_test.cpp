...
namespace
{
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T(""), _T(""), false, true, 0, 0, false);
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T(""), _T("abcde"), false, true, 0, 0, false);
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde"), _T(""), false, true, 0, 0, false);
		EXPECT_EQ(1, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde"), _T("abcde"), false, true, 0, 0, false);
		EXPECT_EQ(0, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcdef"), _T("abcde"), false, true, 0, 0, false);
		EXPECT_EQ(1, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde"), _T("abcde"), true, true, 0, 0, false);
		EXPECT_EQ(0, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde abcde"), _T("abcde abcde"), false, true, 1, 0, false);
		EXPECT_EQ(0, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde"), _T("abcde"), true, true, 2, 0, false);
		EXPECT_EQ(0, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde abcde"), _T("abcdeabcde"), true, true, 2, 0, false);
/// FIXME:
// 		EXPECT_EQ(0, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde abcde"), _T("abcde	abcde"), true, true, 2, 0, false);
		EXPECT_EQ(0, diffs.size());
	}
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("aBcde fghij"), _T("abcde fghij"), true, true, 0, 0, false);
		EXPECT_EQ(1, diffs.size());
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde fgHIj klmno"), _T("abcde fghij klmno"), true, true, 0, 0, false);
		EXPECT_EQ(1, diffs.size());
		strdiff::wdiff *pDiff = &diffs[0];
		if (diffs.size() == 1)
		{
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde,fghij"), _T("ABcde,fghij"), true, true, 0, 1, false);
		EXPECT_EQ(1, diffs.size());
		strdiff::wdiff *pDiff = &diffs[0];
		if (diffs.size() == 1)
		{
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("Abcde,fghij,klmno"), _T("abcde,fghij,klmno"), true, true, 0, 1, false);
		EXPECT_EQ(1, diffs.size());
		strdiff::wdiff *pDiff = &diffs[0];
		if (diffs.size() == 1)
		{
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abcde"), _T("abcde"), true, true, 0, 0, true);
	...
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abc\r\n"), _T("abc\r"), true, false, 0, 0, true);
		EXPECT_EQ(0, diffs.size());
	}

	TEST_F(StringDiffsTest, IgnoreEOL3)
	{
		std::vector<strdiff::wdiff> diffs = strdiff::ComputeWordDiffs(_T("abc\r\n"), _T("abc"), true, false, 0, 0, true);
		EXPECT_EQ(0, diffs.size());
	}
