...
class LeftAndRightNonRecursiveTest : public testing::Test
{
protected:
	LeftAndRightNonRecursiveTest() : m_pProjectFile(nullptr), m_pProjectFileItem(nullptr)
	{
		// You can do set-up work for each test	here.
	}

	virtual ~LeftAndRightNonRecursiveTest()
	{
 ...
 */
TEST_F(LeftAndRightNonRecursiveTest, Load)
{
 ...
 */
TEST_F(LeftAndRightNonRecursiveTest, GetRightPath)
{
	// Has right path
 ...
 */
TEST_F(LeftAndRightNonRecursiveTest, GetSubfolders)
{
	...
	ASSERT_TRUE(subfolders == 0);
}

/**
 * @brief Make sure filter is not get.
 */
TEST_F(LeftAndRightNonRecursiveTest, GetFilter)
{
 ...
 */
TEST_F(LeftAndRightNonRecursiveTest, GetPrediffer)
{
 ...
 */
TEST_F(LeftAndRightNonRecursiveTest, GetUnpacker)
{
