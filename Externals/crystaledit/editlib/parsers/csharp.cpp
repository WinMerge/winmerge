...
unsigned
CrystalLineParser::ParseLineCSharp (unsigned dwCookie, int nLineIndex, const tchar_t *pszChars, int nLength, TEXTBLOCK * pBuf, int &nActualItems, void *pContext)
{
  return ParseLineCJava (dwCookie, nLineIndex, pszChars, nLength, pBuf, nActualItems, IsCppKeyword, nullptr, pContext);
}
