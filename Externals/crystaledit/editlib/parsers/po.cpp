...
//  PO keywords
static const tchar_t *s_apszPoKeywordList[] =
  {
    _T ("msgctxt"),
    _T ("msgid"),
    _T ("msgid_plural"),
...
static bool
IsPoKeyword (const tchar_t *pszChars, int nLength)
{
...
unsigned
CrystalLineParser::ParseLinePo (unsigned dwCookie, int nLineIndex, const tchar_t *pszChars, int nLength, TEXTBLOCK * pBuf, int &nActualItems, void *pContext)
{
  if (nLength == 0)
