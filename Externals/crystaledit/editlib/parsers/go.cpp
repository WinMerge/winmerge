...
//  Go keywords
static const tchar_t * s_apszGoKeywordList[] =
  {
    _T ("break"),
    _T ("case"),
    _T ("chan"),
...
static bool
IsGoKeyword (const tchar_t *pszChars, int nLength)
{
...
unsigned
CrystalLineParser::ParseLineGo (unsigned dwCookie, int nLineIndex, const tchar_t *pszChars, int nLength, TEXTBLOCK * pBuf, int &nActualItems, void *pContext)
{
  if (nLength == 0)
