...
static bool
IsSqlKeyword (const TCHAR *pszChars, int nLength)
{
...
unsigned
CrystalLineParser::ParseLineSql (unsigned dwCookie, const TCHAR *pszChars, int nLength, TEXTBLOCK * pBuf, int &nActualItems)
{
  if (nLength == 0)
