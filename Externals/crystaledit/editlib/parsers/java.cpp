...
unsigned
CrystalLineParser::ParseLineJava (unsigned dwCookie, int nLineIndex, const tchar_t *pszChars, int nLength, TEXTBLOCK * pBuf, int &nActualItems, void *pContext)
{
  return ParseLineCJava (dwCookie, nLineIndex, pszChars, nLength, pBuf, nActualItems, IsJavaKeyword, nullptr, pContext);
}
