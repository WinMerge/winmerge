...
//  Windows resources keywords
static const tchar_t * s_apszRsrcKeywordList[] =
  {
    _T ("ACCELERATORS"),
    _T ("ALT"),
    _T ("ASCII"),
...
static bool
IsRsrcKeyword (const tchar_t *pszChars, int nLength)
{
...
unsigned
CrystalLineParser::ParseLineRsrc (unsigned dwCookie, const tchar_t *pszChars, int nLength, TEXTBLOCK * pBuf, int &nActualItems, void *pContext)
{
  if (nLength == 0)
