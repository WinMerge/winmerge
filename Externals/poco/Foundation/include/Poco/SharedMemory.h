...
public:
	...
	SharedMemory(const std::string& name, std::size_t size, AccessMode mode, const void* addrHint = NULL, bool server = true);
	...
	SharedMemory(const File& file, AccessMode mode, const void* addrHint = NULL);
