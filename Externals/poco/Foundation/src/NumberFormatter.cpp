...
void NumberFormatter::append(std::string& str, int value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%*d", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append0(std::string& str, int value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*d", width, value);
	str.append(buffer);
}
...
void NumberFormatter::appendHex(std::string& str, int value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*X", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append(std::string& str, unsigned value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%*u", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append0(std::string& str, unsigned int value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*u", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append(std::string& str, long value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%*ld", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append0(std::string& str, long value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*ld", width, value);
	str.append(buffer);
}
...
void NumberFormatter::appendHex(std::string& str, long value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*lX", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append(std::string& str, unsigned long value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%*lu", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append0(std::string& str, unsigned long value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*lu", width, value);
	str.append(buffer);
}
...
{
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%" I64_FMT "d", value);
	str.append(buffer);
}
...
void NumberFormatter::append(std::string& str, Int64 value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%*" I64_FMT "d", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append0(std::string& str, Int64 value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*" I64_FMT "d", width, value);
	str.append(buffer);
}
...
{
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%" I64_FMT "X", value);
	str.append(buffer);
}
...
void NumberFormatter::appendHex(std::string& str, Int64 value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*" I64_FMT "X", width, value);
	str.append(buffer);
}
...
{
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%" I64_FMT "u", value);
	str.append(buffer);
}
...
void NumberFormatter::append(std::string& str, UInt64 value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%*" I64_FMT "u", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append0(std::string& str, UInt64 value, int width)
{
	...
	char buffer[64];
	::sprintf_s(buffer, sizeof(buffer), "%0*" I64_FMT "u", width, value);
	str.append(buffer);
}
...
void NumberFormatter::append(std::string& str, const void* ptr)
{
	char buffer[24];
		...
		::sprintf_s(buffer, sizeof(buffer), "%016lX", (UIntPtr) ptr);
	#else
		::sprintf_s(buffer, sizeof(buffer), "%016" I64_FMT "X", (UIntPtr) ptr);
	#endif
#else
	::sprintf_s(buffer, sizeof(buffer), "%08lX", (UIntPtr) ptr);
#endif
	str.append(buffer);
}
